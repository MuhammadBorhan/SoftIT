      ...
      <div className="bg-gray-200 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 px-10  gap-10 ">
          <Service
            ...
            icon={
              <FaFileCode className="w-16 h-16 text-red-500 relative left-[40%] lg:left-[44%] top-4" />
            }
          />
          <Service
            ...
            icon={
              <AiOutlineDesktop className="w-16 h-16 text-red-500 relative left-[40%] lg:left-[44%] top-4" />
            }
          />
          <Service
            ...
            icon={
              <BsBarChart className="w-16 h-16 text-red-500 relative left-[40%] lg:left-[44%] top-4" />
            }
          />
          <Service
            ...
            icon={
              <MdOutlineDeveloperMode className="w-16 h-16 text-red-500 relative left-[40%]  top-4" />
            }
          />
          <Service
            ...
            icon={
              <SiAltiumdesigner className="w-16 h-16 text-red-500 relative left-[40%] lg:left-[44%] top-4" />
            }
          />
          <Service
            ...
            icon={
              <SiMicrosoftsharepoint className="w-16 h-16 text-red-500 relative left-[40%] lg:left-[44%] top-4" />
            }
          />
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 px-10 gap-10 mt-4">
        <img src={applmngt} alt="image" />
        <img src={apps} alt="image" />
        <img src={business} alt="image" />
        <img src={db} alt="image" />
        <img src={insource} alt="image" />
