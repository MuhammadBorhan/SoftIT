  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 px-10 my-16 gap-10">
      <Content
        ...
        icon={
          <AiOutlineDribbbleSquare className="w-12 h-12 rounded-full p-2 text-white bg-blue-500 relative left-[44%] bottom-6" />
        }
      />
      <Content
        title="Our Vision"
        ...
        icon={
          <MdVisibility className="w-12 h-12 rounded-full p-2 text-white bg-blue-500 relative left-[44%] bottom-6" />
        }
      />
      <Content
        title="Our Objective"
        ...
        icon={
          <MdOutlineEmojiObjects className="w-12 h-12 rounded-full p-2 text-white bg-blue-500 relative left-[44%] bottom-6" />
        }
      />
    </div>
  );
